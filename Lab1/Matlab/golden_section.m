...
for(l = 0.003:step: 0.1) % Testing for different values of l
    [a1, b1, f1_count] = Golden_Section(f1, in_a, in_b, l);
    [a2, b2, f2_count] = Golden_Section(f2, in_a, in_b, l);
    [a3, b3, f3_count] = Golden_Section(f3, in_a, in_b, l);
    if(k == 1)
        interv1a = a1;
        interv1b = b1;
        interv2a = a2;
...
xlabel('l values');
title('Golden Section Method for f1(x): evaluations of f1(x) against different values of l');
grid on;
...
ylabel('Function Evaluations');
xlabel('l values');
title('Golden Section Method for f2(x): evaluations of f2(x) against different values of l');
grid on;
...
ylabel('Function Evaluations');
xlabel('l values');
title('Golden Section Method for f3(x): evaluations of f3(x) against different values of l');
grid on;
...
legend;
title('Golden Section Method for f1(x): ak and bk against iteration k');
grid on;
...
ylabel('Interval Boundaries');
legend;
title('Golden Section Method for f2(x): ak and bk against iteration k');
grid on;
...
ylabel('Interval Boundaries');
legend;
title('Golden Section Method for f3(x): ak and bk against iteration k');
grid on;

%---------------------------------------GOLDENSECTIONFUNCTION-----------------------------------------------------%

function[a, b, f_count] = Golden_Section(f, in_a, in_b, l)
